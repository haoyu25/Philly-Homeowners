...
owner_property_count <- owner_property_count %>%
  mutate(owner_property_count = ifelse(property_count >= 10, 1, owner_property_count))
...
residential_properties <- residential_properties %>%
  left_join(owner_property_count %>%
              dplyr::select(owner_1, owner_property_count), 
            by = "owner_1") %>%
  mutate(owner_property_count = ifelse(is.na(owner_property_count), 0, owner_property_count))
...
properties_model <- residential_properties %>% dplyr::select(objectid, census_tract, geographic_ward, zip_code, 
                                                      ...
                                                      is_deep, large_area,owner_property_count,
                                                      ...
                                                      limited_english_rate, diversity_index,#median_income, 
