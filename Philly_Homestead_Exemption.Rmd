...
```{r}
properties <- fread("C:/Users/rache/Documents/Github/Philly-Homeowners/Data/opa_properties_public.csv")
...
ownerstoremove <- properties %>%
  ...
  filter(str_detect(owner_1, "LLC|REAL ESTATE|ASSOC|INVESTMENT|CHURCH|REALTY|PROPERTIES|SPECIAL PEOPLE IN NORTHEA|NORTH FOURTH STREET|BANKERS TRUST|RENTALS|PARTICIPATION|FAIRMOUNT PARK|THE LOFTS|FUND|WHARTON COURT|GROUP|DELAWARE RIVER|BELL TELEPHONE CO|VET AFFAIRS|FEDERAL|WORKFORCE|PENNDOT|INVESTORS|AFFORDABLE|INTERSTATE|INC|KOREAN COMMUNITY DEVELOPM|CITY|UNITED STATES OF AMERICA|PHILA|NON PROFIT|ASSO|HOUSE|NEIGHBORHOOD|UNIV|HOUSING|PROPERTY|COMMONWEALTH|CONRAIL|AUTHORITY|SEPTA|CORP")) %>%
...
# View the result
print(owner_property_count, n = 100)
```
