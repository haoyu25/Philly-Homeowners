...
properties_model <- residential_properties %>% dplyr::select(objectid, census_tract, geographic_ward, zip_code, 
                                                      ...
                                                      is_deep, large_area,owner_count,
                                                      ...
                                                      pct_foreign_born,
                                                      overall_vacancy_rate, poverty_rate, #bach_degree_rate,
...
numericVars <- as.data.frame(properties_model) %>%
  dplyr::select(exemption,
                same_address, perc_bdg_exempt,
                likely_other_prog, tax_bdg_status,is_deep, large_area,owner_count,
                rental_license, commercial_license, balance_rate, 
                avg_market_value, sd_market_value,has_recent_transfer, latest_document_type,
                pct_foreign_born,overall_vacancy_rate,poverty_rate, 
                young_owner_rate,senior_owner_rate,
