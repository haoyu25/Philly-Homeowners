...
data <- st_read("C:/Users/rache/Documents/Github/Philly-Homeowners/COSTBeni/properties_wo_exemption_0505pred.geojson")


old_data <- st_read("C:/Users/rache/Documents/Github/Philly-Homeowners/COSTBeni/property_without_exemption_tractdata.geojson")
...
```{r}
data1 <- read.csv("C:/Users/rache/Documents/Github/Philly-Homeowners/COSTBeni/xgb_full_pred_0505.csv")
