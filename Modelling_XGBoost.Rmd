...
The threshold is set at 0.5, where any predictions with a probability of 0.5 or over are categorized as predicted to be eligible for the exemption.
```{r}
...
A confusion matrix of the model results was then produced. 
```{r}
